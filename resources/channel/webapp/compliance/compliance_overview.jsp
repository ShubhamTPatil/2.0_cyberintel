...
<logic:equal name="action1" value="">
    <webapps:formtabs tabset="compTgtView" tab="confgAssmentGroupCompliance" subtab="compOverview" />
</logic:equal>
<logic:notEqual name="action1" value="">
    <webapps:formtabs tabset="compOverallDashboard" tab="confgAssmentOverallDashboard"/>
</logic:notEqual>
        ...
        <div class="dashboard-box">
            ...
            <div class="box-body" id="div_top5_vulnerable_serverUp">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="dashboard-box">
                            <div class="box-header"><h3 class="box-title">Top 5 Vulnerable Groups</h3></div>
                            <div class="box-body" id="div_top5_vulnerable_groups_data">
                                <div class="row text-center"><div class="col-md-12"><div class="text-orange text-bold">Select "Security Content" and "Security Profle" to list top 5 vulnerable groups</div></div></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="dashboard-box">
                            <div class="box-header"><h3 class="box-title">Top 5 Vulnerable Rules</h3></div>
                            <div class="box-body" id="div_top5_vulnerable_rules_data">
                                <div class="row text-center"><div class="col-md-12"><div class="text-orange text-bold">Select "Security Content" and "Security Profle" to list top 5 vulnerable rules</div></div></div>
                            </div>
                        </div>
                    </div>
                </div>
...
function loadScapFromDB(secondaryAction) {
    $.ajax({
        type: "GET", dataType: "json", url: "/spm/overView.do",
...
function getVulnerablityDetails() {
    ...
    $.ajax({
        ...
        beforeSend: function() {showSpinner('div_top5_vulnerable_groups_data'); showSpinner('div_top5_vulnerable_rules_data');},
        success: function (data) {populateTop5VulnerableData(data.groups, data.rules);},
        complete: function(jqXHR, textStatus) {closeSpinnerForce('div_top5_vulnerable_groups_data'); closeSpinnerForce('div_top5_vulnerable_rules_data');},
        error: function(jqXHR, textStatus, errorThrown) {closeSpinnerForce('div_top5_vulnerable_groups_data'); closeSpinnerForce('div_top5_vulnerable_rules_data');}
    });
}
...
function populateTop5VulnerableData(groups, rules) {
    var contentToDisplay_groups = '';
    var contentToDisplay_rules = '';

    $.each(groups, function(i, item) {
        contentToDisplay_groups += '<div class="row"><div class="progress-group"><div class="col-md-12"><div class="progress-text">'+ item.name + ' ('+ item.percentage +' %) </div>'
    ...
    contentToDisplay_groups = (contentToDisplay_groups === '') ? '<div class="row text-center"><div class="col-md-12"><div class="text-red text-bold">No Records Found</div></div></div>' : contentToDisplay_groups;
    ...
    $('#div_top5_vulnerable_groups_data').html(contentToDisplay_groups);
