...
<webapps:formtabs tabset="compTargetView" tab="confgAssmentMachineCompliance" subtab="compTgtOverview"/>
                                    ...
                                    <span class="progress-text" style="padding-bottom:3px">
                                        ...
                                        <logic:notEqual name="profile" property="complaintLevel" value="NOT-CHECKED-IN">
                                            ...
                                            <logic:notEqual name="profile" property="complaintLevel" value="NOT APPLICABLE">
                                                &nbsp;[<a href="#" onclick="window.parent.showProfileComplianceReport('<bean:write name="profile" property="contentName" />', 'xccdf')"><bean:write name="profile" property="complaintLevel" /></a>]
                                            </logic:notEqual>
                                        </logic:notEqual>
                                    </span>
