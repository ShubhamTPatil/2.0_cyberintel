...
<logic:present name="target">
    ...
    <logic:notEqual name="target" property="type" value="<%=ISubscriptionConstants.TYPE_MACHINE%>">
        <logic:notEqual name="target" property="type" value="<%=ISubscriptionConstants.TYPE_USER%>">
            <logic:equal name="view" value="target">
                <webapps:formtabs tabset="compTgtView" tab="vulnerAssmentGroupCompliance" subtab="compSecurityProfile" />
                <%@ include file="/compliance/vulner_compliance_security_targets.jsp" %>
            </logic:equal>
            <logic:equal name="view" value="overall">
                <webapps:formtabs tabset="compTgtView" tab="vulnerAssmentGroupCompliance" subtab="comMachine" />
                <%@ include file="/compliance/vulner_compliance_security_overall.jsp" %>
            </logic:equal>
        </logic:notEqual>
    </logic:notEqual>
    ...
    <logic:equal name="target" property="type" value="<%=ISubscriptionConstants.TYPE_MACHINE%>">
        <logic:equal name="view" value="target">
            <webapps:formtabs tabset="compTargetView" tab="vulnerAssmentMachineCompliance" subtab="compTarget" />
