    ...
    <main id="main" class="main">
      ...
      <section class="section dashboard">
            ...
            <logic:present scope="request" name="duplicateChangeRequestExists">
              <div class="statusMessage" id="critical" align="left">
                ...
                <logic:equal name="duplicateChangeRequestExists" value="servicenow">
                  <p>
                    <webapps:pageText key="servicenow.duplicate" />
                  </p>
                </logic:equal>
                <logic:equal name="duplicateChangeRequestExists" value="remedyforce">
                  <p>
                    <webapps:pageText key="remedyforce.duplicate" />
                  </p>
                </logic:equal>
              </div>
            </logic:present>
                    ...
                    <tr>
                      <td colspan="2">
                        <div class="card-title">
                          <webapps:pageText key='<%=(String) previewValues.getValue("title")%>' />
                        </div>
                      </td>
                    </tr>
                  </logic:present>
                    ...
                    <logic:notPresent name="previewValues" property="value(nodisplay)">
                      <logic:notPresent name="previewValues" property="value(hidden)">
                        <logic:notPresent name="previewValues" property="value(changed)">
                          <tr>
                            <td align="right"><webapps:pageText key='<%=(String) previewValues.getValue("displayname")%>' /></td>
                            <td><logic:present name="previewValues" property="value(externalized)">
                                <webapps:pageText key="<%=(String) previewValues.getValue("assignedValue")%>" />
                              </logic:present> <logic:notPresent name="previewValues" property="value(externalized)">
                        ...
                        <logic:present name="previewValues" property="value(changed)">
                          <td align="right"><webapps:pageText key='<%=(String) previewValues.getValue("displayname")%>' /></td>
                          <td><span class="textHighlighted"> <logic:present name="previewValues" property="value(externalized)">
                                <webapps:pageText key="<%=(String) previewValues.getValue("assignedValue")%>" />
                              </logic:present> <logic:notPresent name="previewValues" property="value(externalized)">
                                <bean:write name="previewValues" property="value(assignedValue)" filter="true" />
                              </logic:notPresent>
        ...
        <div class="col" style="text-align: right;">
          <input type="submit" class="btn btn-sm btn-primary" value="<webapps:pageText key="btnpublish" />" styleClass="mainBtn"> <input type="button" class="btn btn-sm btn-outline-primary" value="<webapps:pageText key="btncancel" />" onClick="javascript:send(document.setPluginForm,'/pluginCancel.do');">
        </div>
