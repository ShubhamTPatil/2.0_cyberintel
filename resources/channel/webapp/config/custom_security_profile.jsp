<%@ page contentType="text/html;charset=UTF-8"%><%@ include file="/includes/directives.jsp"%><webapps:helpContext context="spm" topic="custom_security_profile" /><%@ page import="com.marimba.apps.subscriptionmanager.intf.IWebAppConstants"%><%
...
function saveState(form, forwardaction) {
    ...
    if ('/customSecurityProfile.do?action=apply' == forwardaction) {
        form.selectedSCAPProfile.value = '<%= request.getAttribute("profile.id")%>';
    } else if ('/customSecurityProfile.do?action=load' == forwardaction) {
    } else {
...
function initialContentProfileSettings() {
    switchContentProfileSettings(document.customSecurityProfileForm.selectedSCAPContent.value);
}
function switchContentProfileSettings(contentname) {
    $.ajax({
        ...
        success: function (response) {
            ...
            document.getElementById('iframeProfileInfo').src = '/spm/securitymgmt?command=gethtml&target=custom&customize=true&content=' + contentname + '&profile=' + profileIdsResponse[0];
        },
...
function switchProfileInfo(profilename) {
    ...
    var srcUrl = '/spm/securitymgmt?command=gethtml&target=custom&customize=true&content=' + guidename + '&profile=' + profilename;
    if (templateName != '') {
...
function loadCustomizationInfo() {
    if (window.frames != null) {
        ...
        <% } %> --%>  <html:form name="customSecurityProfileForm" action="/customSecurityProfile.do" type="com.marimba.apps.subscriptionmanager.webapp.forms.CustomSecurityProfileForm">    <html:hidden property="create" />    <html:hidden property="modifiedRules" />    <html:hidden property="selectedSCAPProfile" />    <main id="main" class="main">      <div class="pagetitle">        <div class="d-flex bd-highlight justify-content-center">          <div class="p-2 flex-grow-1 bd-highlight">            <logic:equal name="customSecurityProfileForm" property="create" value="true">              <span class="pagename"><webapps:pageText key="TitleAdd" /></span>              <span data-bs-toggle="tooltip" data-bs-placement="right" title="<webapps:pageText key="TitleAdd"/>"><i class="fa-solid fa-circle-info text-primary"></i></span>            </logic:equal>            <logic:notEqual name="customSecurityProfileForm" property="create" value="true">              <span class="pagename"><webapps:pageText key="TitleEdit" /></span>              <span data-bs-toggle="tooltip" data-bs-placement="right" title="<webapps:pageText key="TitleEdit"/>"><i class="fa-solid fa-circle-info text-primary"></i></span>            </logic:notEqual>          </div>          <div class="refresh p-2 bd-highlight text-primary align-self-center" data-bs-toggle="tooltip" data-bs-placement="right" title="Refresh" style="cursor: pointer;">            <i class="fa-solid fa-arrows-rotate"></i>          </div>          <div class="p-2 bd-highlight text-primary align-self-center">            <a href="/shell/dashboard.do"> <i class="fa-solid fa-chevron-left" style="margin-right: 5px;"></i>CMS Home            </a>          </div>        </div>      </div>      <section class="section dashboard">        <div class="card">          <div class="card-body">            <br />            <%@ include file="/includes/usererrors.jsp"%>            <%@ include file="/includes/help.jsp"%>            <br/>            <table border="0" cellspacing="0" cellpadding="3" style="width:100%;">              <tr>                <td align="left" style="padding-top: 5px; padding-bottom: 5px"><webapps:pageText key="label.profileName" /></td>                <td style="padding-top: 5px; padding-bottom: 5px"><logic:equal name="customSecurityProfileForm" property="create" value="true">                    <html:text property="name" size="30" maxlength="30" styleClass="requiredField" onkeyup="nospaces(this)" />                  </logic:equal> <logic:notEqual name="customSecurityProfileForm" property="create" value="true">                    <html:hidden property="name" />                    <b><bean:write name="customSecurityProfileForm" property="name" /></b>                  </logic:notEqual></td>              </tr>              <tr>                <td align="left" style="padding-top: 5px; padding-bottom: 5px"><webapps:pageText key="label.profileDesc" /></td>                <td style="padding-top: 5px; padding-bottom: 5px"><html:text property="description" size="50" maxlength="100" styleClass="requiredField" /></td>              </tr>              <tr>                <td align="left" style="padding-top: 5px; padding-bottom: 5px"><logic:equal name="customSecurityProfileForm" property="create" value="true">                    <webapps:pageText key="label.customcontent.select" />                  </logic:equal> <logic:notEqual name="customSecurityProfileForm" property="create" value="true">                    <webapps:pageText key="label.customcontent.standard" />                  </logic:notEqual></td>                <td style="padding-top: 5px; padding-bottom: 5px"><logic:equal name="customSecurityProfileForm" property="create" value="true">                    <html:select property="selectedSCAPContent" styleId="guide_id" onchange="switchContentProfileSettings(this.value)">                      <html:options collection="insynccustomcontentdetailsmap" property="key" labelProperty="value" />                    </html:select>                  </logic:equal> <logic:notEqual name="customSecurityProfileForm" property="create" value="true">                    <b><%= request.getAttribute("content.title")%></b>                  </logic:notEqual></td>              </tr>              <tr>                <td align="left" style="padding-top: 5px; padding-bottom: 5px">                  <logic:equal name="customSecurityProfileForm" property="create" value="true">                    <webapps:pageText key="label.customprofile.select" />                  </logic:equal>                                     <logic:notEqual name="customSecurityProfileForm" property="create" value="true">                    <webapps:pageText key="label.customprofile.standard" />                  </logic:notEqual></td>                <td style="padding-top: 5px; padding-bottom: 25px">                  <div id="selectedSCAPProfileDiv">                    <logic:equal name="customSecurityProfileForm" property="create" value="true">                      <html:select property="selectedSCAPProfileSelect" styleId="selectedSCAPProfileId" onchange="switchProfileInfo(this.value)">                        <html:options collection="first_custom_content_profiles" property="key" labelProperty="value" />                      </html:select>                    </logic:equal>                    <logic:notEqual name="customSecurityProfileForm" property="create" value="true">                      <b><%= request.getAttribute("profile.title")%></b>                    </logic:notEqual>                  </div>                </td>              </tr>              <tr>                <td colspan="2"><iframe id="iframeProfileInfo" src='<bean:write name="customSecurityProfileForm" property="initialIFramePath"/>' width="100%" height="625px" frameBorder="0"></iframe></td>              </tr>              <!--<tr>
              ...
              </tr>-->            </table>          </div>        </div>        <div class="col" style="text-align: end;">          <logic:equal name="customSecurityProfileForm" property="create" value="true">            <input type="button" class="btn btn-sm btn-primary mainBtn" name="save" value=" <webapps:pageText key="save" type="global" /> " onClick="javascript:saveState(document.customSecurityProfileForm, '/customSecurityProfile.do?action=save');">          </logic:equal>          <logic:notEqual name="customSecurityProfileForm" property="create" value="true">            <input type="button" class="btn btn-sm btn-primary mainBtn" name="apply" value=" <webapps:pageText key="saveandapply" type="global" /> " onClick="javascript:saveState(document.customSecurityProfileForm, '/customSecurityProfile.do?action=apply');">          </logic:notEqual>          <input type="button" class="btn btn-sm btn-outline-primary" name="cancel" value=" <webapps:pageText key="Cancel" type="global" /> " onclick="javascript:saveState(document.customSecurityProfileForm, '/customSecurityProfile.do?action=load');">        </div>        <%@ include file="/dashboard/endMainSection.jsp"%>  </html:form></body></html>