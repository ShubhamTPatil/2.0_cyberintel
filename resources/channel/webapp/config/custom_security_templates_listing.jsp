    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="middle" class="smallButtons">
            <td nowrap class="tableRowActions">
                <input disabled name="removeBtn" id="removeBtn" type="button" value="<webapps:pageText key="remove" type="button" shared="true"/>" onClick="javascript:saveState(document.customSecurityProfileForm, '/customSecurityTemplateListing.do?action=remove');">
            </td>
            <td nowrap class="tableRowActions">
                <input disabled name="editBtn" id="editBtn" type="button" value="<webapps:pageText key="edit" type="button" shared="true"/>" onClick="javascript:saveState(document.customSecurityProfileForm, '/customSecurityTemplateListing.do?action=edit');">
            </td>
            <td nowrap class="tableRowActions" width="100%" align="right">
                <input name="addBtn" id="addBtn" type="button" value="<webapps:pageText key="add" type="button" shared="true"/>" onClick="javascript:saveState(document.customSecurityProfileForm, '/customSecurityTemplateListing.do?action=add');">
            </td>
        </tr>
    </table>
...
%>
<b>Marimba vDef used in your environment doesn't include any vMediate in it. <br>Please check with your Administrator on availability of any new updates for Security Info.</b>
<%
}
%>
</div>
...
<div id="pageNav">
    <input type="button" class="mainBtn" name="done" value=" <webapps:pageText key="done" shared="true" type="button" /> " onClick="javascript:saveState(document.customSecurityProfileForm, '/config.do');">
</div>
</div>
</div>
</div>
