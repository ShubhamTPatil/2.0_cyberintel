                    ...
                    <div style="width:1000px">
                        <div align="left" style="padding-left:8px;">
                            <table border="0" cellspacing="0" cellpadding="3">
                                ...
                                <tr>
                                    <td colspan="2">
                                         <iframe id="iframeProfileInfo" src='<bean:write name="scapSecurityProfileForm" property="initialIFramePath"/>' width="1100px" height="625px" frameBorder="0"></iframe>
                                    </td>
                                </tr>
                                <!--<tr>
                        ...
                        <div id="pageNav" style="padding-left:110px;">
                            <logic:equal name="scapSecurityProfileForm" property="create" value="true">
                                <input type="button" class="mainBtn" name="save" value=" <webapps:pageText key="save" type="global" /> " onClick="javascript:saveState(document.scapSecurityProfileForm, '/scapSecurityProfile.do?action=save');">
                            </logic:equal>
                            <logic:notEqual name="scapSecurityProfileForm" property="create" value="true">
                                <input type="button" class="mainBtn" name="apply" value=" <webapps:pageText key="saveandapply" type="global" /> " onClick="javascript:saveState(document.scapSecurityProfileForm, '/scapSecurityProfile.do?action=apply');">
                            </logic:notEqual>
                            <input type="button" name="cancel" value=" <webapps:pageText key="Cancel" type="global" /> " onclick="javascript:saveState(document.scapSecurityProfileForm, '/scapSecurityProfile.do?action=load');" >
                        </div>
                    </div>
                </div>
            </div>
