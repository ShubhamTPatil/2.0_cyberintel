...
<main id="main" class="main">
    ...
    <div class="card">
    	<div class="card-body">
    		...
    		<br/><br/>
    		<span class="textGeneral"><webapps:pageText key="pluginStatus"/></span>
    		...
    		<table border="0" cellspacing="1" cellpadding="5">
    			...
    			<tr>
    				<td align="right" valign="top">
    					<webapps:pageText key="SubscriptionURL"/>
    				</td>
    				<td valign="top">
	...
	<div class="col" style="text-align: right;">
		<input type="submit" class="mainBtn btn btn-sm btn-primary" value="<webapps:pageText shared="true" type="button" key="preview"/>" />
	    <input type="button" class="btn btn-sm btn-outline-primary" value="<webapps:pageText shared="true" type="button" key="cancel"/>" onClick="javascript:send(document.setPluginForm,'/pluginCancel.do');" >
    </div>
