                        ...
                        if (requiredIFrameDoc != null) {
                            ...
                            if (customization != null) {
                                for(int i=0; i<customization.length; i+=2) { %>
                                    ...
                                    </td>                  </tr>-->                </table>              </div>            </div>                    <div class="col" style="text-align: end;">            <logic:equal name="usgcbSecurityProfileForm" property="create" value="true">              <input type="button" class="btn btn-sm btn-primary mainBtn" name="save" value=" <webapps:pageText key="save" type="global" /> " onClick="javascript:saveState(document.usgcbSecurityProfileForm, '/usgcbSecurityProfile.do?action=save');">            </logic:equal>            <logic:notEqual name="usgcbSecurityProfileForm" property="create" value="true">              <input type="button" class="btn btn-sm btn-primary mainBtn" name="apply" value=" <webapps:pageText key="saveandapply" type="global" /> " onClick="javascript:saveState(document.usgcbSecurityProfileForm, '/usgcbSecurityProfile.do?action=apply');">            </logic:notEqual>            <input type="button" class="btn btn-sm btn-outline-primary " name="cancel" value=" <webapps:pageText key="Cancel" type="global" /> " onclick="javascript:saveState(document.usgcbSecurityProfileForm, '/usgcbSecurityProfile.do?action=load');">          </div>                <%@ include file="/dashboard/endMainSection.jsp"%>  </html:form></body></html>