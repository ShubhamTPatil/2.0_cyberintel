...
--%>
<%--
     This class When we select the selected target hyperlink from package view page, selected channels will be displayed in a glass pane
...
<!-- Transparent cover -->
<%String channelListAction = request.getContextPath() + "/multiChannelListDisplay.do"; %>
...
<script type="text/javascript">
    ...
    function showMultiChannels() {
        document.getElementById('multiEditHolder').src = '<webapps:fullPath path="/multiChannelListDisplay.do" />';
        var width = 620;
        var height = 500;
