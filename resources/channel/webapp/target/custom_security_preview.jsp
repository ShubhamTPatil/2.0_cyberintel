...
%>
<webapps:helpContext context="spm" topic="custom_policy_preview" />
...
<script type="text/javascript">
    ...
    function saveState(forwardaction) {
        document.customSecurityForm.forward.value = forwardaction;
...
<logic:notPresent name="copy_preview">
    <webapps:formtabs tabset="distPreview" tab="custom" />
</logic:notPresent>

<logic:present name="copy_preview">
    <webapps:formtabs tabset="copyPreview" tab="custom" />
</logic:present>
...
<div class="formContent" id="mainSection" style="overflow:auto; text-align:left; padding-top:20px;">
    <table width="70%" border="0" cellspacing="0" cellpadding="4" style="padding-left:80px;">
        <tr>
            <logic:equal name="customSecurityForm" property="selectedSCAPOption" value="exclude">
                <td nowrap style="padding-left:15px;" colspan="2"> <webapps:pageText key="label.excludeprofile"/>
            </logic:equal>
        </tr>
        <logic:equal name="customSecurityForm" property="selectedSCAPOption" value="customize">
            <tr>
                <td nowrap style="padding-left:15px;" colspan="2"><b>Selected Profile Type:</b> Custom</td>
                <td nowrap>
                    <logic:notEqual name="customSecurityForm" property="customizePriorityValue" value="">
                        <webapps:pageText key="Priority"/> &nbsp; <bean:write name="customSecurityForm" property="customizePriorityValue"/>
                    </logic:notEqual>
                    <logic:equal name="customSecurityForm" property="customizePriorityValue" value="">
            ...
            <tr>
                <td style="padding-left:15px;" colspan="3">
                    <table border="1" width="100%" style="border-collapse:collapse;">
                        ...
                        <logic:iterate name="customSecurityForm" id="preview_list_map" property="previewList">
                            <tr>
        ...
        <logic:equal name="customSecurityForm" property="selectedSCAPOption" value="standard">
            <tr>
                <td nowrap style="padding-left:15px;" colspan="2"><b>Selected Profile Type:</b> Standard</td>
                <td nowrap>
                    <logic:notEqual name="customSecurityForm" property="standardPriorityValue" value="">
                        <webapps:pageText key="Priority"/> &nbsp; <bean:write name="customSecurityForm" property="standardPriorityValue"/>
                    </logic:notEqual>
                    <logic:equal name="customSecurityForm" property="standardPriorityValue" value="">
                        <webapps:pageText key="Priority"/> &nbsp; <webapps:pageText key="NullDate" type="global"/>
                    </logic:equal>
                </td>
            </tr>
...
<div id="pageNav">
    <logic:present name="copy_preview" >
        <input name="copy" type="button" class="mainBtn" accesskey="N" onClick="javascript:send(document.customSecurityForm, '/copySaveTarget.do');" value="<webapps:pageText key="copy" type="button" shared="true"/>">
        &nbsp;
        <input name="Submit32" type="button" onClick="javascript:send(document.customSecurityForm,'/copyAdd.do?action=back');" value="<webapps:pageText key="backToEdit" type="button" shared="true"/>">
        &nbsp;
    ...
    <logic:notPresent name="copy_preview">
        <input name="save" type="submit" class="mainBtn" accesskey="N" onClick="javascript:send(document.customSecurityForm, '/distSave.do');" value="<webapps:pageText key="save" type="button" shared="true"/>">
        &nbsp;
        <input name="Submit32" type="submit" onClick="javascript:send(document.customSecurityForm, '/distInit.do?action=back');" value="<webapps:pageText key="backToEdit" type="button" shared="true"/>">
        &nbsp;
        <logic:present name="taskid">
