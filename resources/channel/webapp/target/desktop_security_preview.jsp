<%--
    ...
    $File://depot/ws/products/subscriptionmanager/9.0.01/resources/channel/webapp/target/security_preview.jsp
...
function saveState(forwardaction) {
  document.desktopSecurityForm.forward.value = forwardaction;
...
<logic:present name="taskid">
    ...
    <logic:present name="copy_preview">
        <webapps:formtabs tabset="copyPreview" tab="windows" subtab="sec" />
    </logic:present>
    ...
    <div class="formContent" id="mainSection" style="overflow:auto; text-align:left; padding-top:20px;">
      <table width="70%" border="0" cellspacing="0" cellpadding="4" style="padding-left:80px;">
        <tr>
          <logic:equal name="desktopSecurityForm" property="value(marimba.subscription.desktop.enable)" value="true">
            <td nowrap style="padding-left:15px;" colspan="2"> <webapps:pageText key="label.profileSelected"/>
            ...
            <td colspan="2">
                <logic:notEqual name="desktopSecurityForm" property="value(priority_value)" value="">
                    <webapps:pageText key="Priority"/> &nbsp;
                    <bean:write name="desktopSecurityForm" property="value(priority_value)"/>
                </logic:notEqual>
                <logic:equal name="desktopSecurityForm" property="value(priority_value)" value="">
        ...
        <tr>
            <td align="center"> <webapps:pageText key="label.user.restrict"/> </td>
            <td align="center"> <webapps:pageText key="label.machine.restrict"/> </td>
            <td align="center"> <webapps:pageText key="label.password.policy"/> </td>
            <td align="center"> <webapps:pageText key="label.allowed.software"/> </td>
        </tr>
    ...
    <div id="pageNav">
      <logic:present name="copy_preview" >
            <input name="copy" type="button" class="mainBtn" accesskey="N" onClick="javascript:send(document.desktopSecurityForm, '/copySaveTarget.do');" value="<webapps:pageText key="copy" type="button" shared="true"/>">
            &nbsp;
            <input name="Submit32" type="button" onClick="javascript:send(document.desktopSecurityForm,'/copyAdd.do?action=back');" value="<webapps:pageText key="backToEdit" type="button" shared="true"/>">
            &nbsp;
      ...
      <logic:notPresent name="copy_preview">
          <input name="save" type="submit" class="mainBtn" accesskey="N" onClick="javascript:send(document.desktopSecurityForm, '/distSave.do');" value="<webapps:pageText key="save" type="button" shared="true"/>">
          &nbsp;
          <input name="Submit32" type="submit" onClick="javascript:send(document.desktopSecurityForm, '/distInit.do?action=back');" value="<webapps:pageText key="backToEdit" type="button" shared="true"/>">
          &nbsp;
          <logic:present name="taskid">
