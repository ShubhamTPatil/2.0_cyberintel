...
public class OVALDashboardDetails implements ComplianceConstants {
    ...
    static class GetMachineData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            String sql = "select oval.machine_id id, oval.assigned_target_name target_name, os.product product, oval.overall_compliant_level status, count(*) count \n" +
                    "from inv_security_oval_compliance oval, inv_os os\n" +
                    "where oval.machine_id= os.machine_id and UPPER(assigned_target_name) like UPPER('"+targetID+"')\n" +
                    "group by oval.machine_id, oval.assigned_target_name, os.product, oval.overall_compliant_level";
    ...
    static class GetMachineCountData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            ...
            String queryStr = "select COUNT(*) from inv_machine im" +
                    "where exists (select 1 from inv_security_oval_compliance  sxc where sxc.machine_id = im.id" +
    ...
    static class GetLast24HourMachineData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            ...
            String queryStr = "select COUNT(*) from ( " +
                    "select machine_id, max(finished_at) as finished_at  from inv_security_oval_compliance sxc where " +
    ...
    static class GetSecurityInUseData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            ...
            String queryStr = "select count(*) as 'Security Scanner in use' from security_oval_content sxct " +
                    "where exists (select 1 from inv_security_oval_compliance  sxc where sxct.id = sxc.content_id " +
    ...
    static class GetOverallComplianceData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            ...
            String queryStr = "select a.Compliant, b.[Non-Compliant] from" +
                    "(select count(*) as 'Compliant' from  inv_security_oval_compliance  sxc" +
                    "where overall_compliant_level = 'Compliant'" +
                    "and UPPER(sxc.assigned_target_name) = UPPER('"+ targetID +"')  a ," +
                    "(select count(*) as 'Non-Compliant' from  inv_security_oval_compliance  sxc" +
    ...
    static class GetSCAPTypeComplianceData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            ...
            String queryStr = "select content_name, profile_name, content_target_os, COUNT('NON-COMPLIANT') 'non-compliant', COUNT ('COMPLIANT') 'compliant' " +
                    "from inv_security_oval_compliance sxc " +
    ...
    public static class GetContentInfoForAllEndpoints extends DatabaseAccess {
        ...
        class GetContentInfoForAllEndpointsData extends QueryExecutor {
            ...
            protected void execute(IStatementPool pool) throws SQLException {
                String queryStr = "select content_title, content_name from inv_security_oval_compliance";
    ...
    public static class GetProfileInfoForAllEndpoints extends DatabaseAccess {
        ...
        class GetProfileInfoForAllEndpointsData extends QueryExecutor {
            ...
            protected void execute(IStatementPool pool) throws SQLException {
                String queryStr = "select profile_name, profile_title from inv_security_oval_compliance where content_title = '"+contentTitle+"'";
    ...
    // todo: need to remove after check with bharath
    ...
    public static class GetRuleNames extends DatabaseAccess {
        ...
        class GetRuleNameData extends QueryExecutor {
            ...
            protected void execute(IStatementPool pool) throws SQLException {
                ...
                String queryStr = "select distinct definition_name, definition_title from security_oval_profile_defn where definition_name in (" + rule_ids + ")";
    ...
    static class GetTotalMachineCountData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            ...
            String queryStr = "select COUNT(im.id) from ldapsync_target_membership ctm, " +
                    ...
                    "    and exists (select 1 from inv_security_oval_compliance isxc " +
    ...
    static class GetAllEndpointMachinesData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            String sql = "select a.machine_id, b.product product, dbo.OVALMachineOverallCompStatus(a.machine_id) status from (\n" +
                    "select distinct machine_id from inv_security_oval_compliance\n" +
    ...
    static class GetAllEndpointScannerWiseCompliantData extends QueryExecutor {
        ...
        protected void execute(IStatementPool pool) throws SQLException {
            ...
            String queryStr = "select content_title, overall_compliant_level, count(overall_compliant_level) as count  from inv_security_oval_compliance sxc " +
    ...
    private static void debug(String msg) {
        if (IAppConstants.DEBUG5) System.out.println("OVAL DashboardDetails: " + msg);
    }
