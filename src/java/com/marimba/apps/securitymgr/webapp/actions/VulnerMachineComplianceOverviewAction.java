...
import com.marimba.apps.subscriptionmanager.webapp.actions.MachineOverviewAction;
...
public class VulnerMachineComplianceOverviewAction extends AbstractAction implements IWebAppConstants, ISubscriptionConstants {
	IUser user = null;
    protected DelayedAction.Task createTask(ActionMapping mapping, ActionForm form, HttpServletRequest request,HttpServletResponse response) {
        return new VulnerMachineComplianceOverviewActionTask(mapping, form, request, response);
    }

    protected class VulnerMachineComplianceOverviewActionTask extends AbstractAction.SubscriptionDelayedTask {
    	VulnerMachineComplianceOverviewActionTask(ActionMapping mapping, ActionForm form, HttpServletRequest request,HttpServletResponse response) {
        ...
        public void execute(){
            ...
            try {
                ...
                if (target != null) {
                    List display_results = SecurityLDAPUtils.getAssignedPolicy(SECURITY_SCAN_TYPE_OVAL, target.getName(), target.getType(), target.getId(), main, user);
