...
/**
 * Overall Site compliance query/report
 *
 * @author  Selvaraj Jegatheesan
 * @version $Revision$, $Date$
 */
public class OverallSiteComplianceQuery extends ComplianceQueryObject {
	 // Query context
    String targetGroup;
    ...
    public OverallSiteComplianceQuery(String targetGroup) {
    ...
    public boolean equals(Object obj) {
	    ...
	    if (!(obj instanceof OverallSiteComplianceQuery)) return false;

	    OverallSiteComplianceQuery qry = (OverallSiteComplianceQuery) obj;
    ...
    public String getQueryPath() {
	    return QUERY_FOLDER_PATH + "OverallSiteSummaryByInventory";
    }
