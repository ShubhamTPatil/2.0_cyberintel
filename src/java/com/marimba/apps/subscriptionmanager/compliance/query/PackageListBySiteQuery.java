...
import java.util.*;
/**
 * Query for SiteCompliance
 *
 * @author  Selvaraj Jegatheesan
 * @version $Revision$, $Date$
 */
public class PackageListBySiteQuery extends ComplianceListQueryObject {
    // Group id for the machine
    String groupId;

    public PackageListBySiteQuery(String groupId) {
    ...
    public boolean equals(Object obj) {
	    ...
	    if (!(obj instanceof PackageListBySiteQuery)) return false;

	    PackageListBySiteQuery qry = (PackageListBySiteQuery) obj;
    ...
    public String getQueryPath() {
	    return QUERY_FOLDER_PATH + "PackagesBySite";
    }
