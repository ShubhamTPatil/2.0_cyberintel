...
public class PowerComplianceQuery extends ComplianceQueryObject {
    ...
    public PowerComplianceQuery(String targetGroup) {
    ...
    public boolean equals(Object obj) {
	    ...
	    if (!(obj instanceof PowerComplianceQuery)) return false;

	    PowerComplianceQuery qry = (PowerComplianceQuery) obj;
    ...
    public String getQueryPath() {
	    return QUERY_FOLDER_PATH + "PowerSummaryByPolicyByTarget";
    }
