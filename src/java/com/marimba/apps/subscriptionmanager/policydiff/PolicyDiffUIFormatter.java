...
/**
 * PolicyDiffUIFormatter for populate diffing content which is used for display in the UI 
 *
 * @author Tamilselvan Teivasekamani
 * @version $Revision$,  $Date$
 */

public class PolicyDiffUIFormatter extends PolicyDiff {
    ...
    public PolicyDiffUIFormatter() {
        super();
        init();
    }

    public PolicyDiffUIFormatter(ISubscription oldsub, ISubscription newsub, SubscriptionMain main) {
    	// todo : if you use this class in future, need to pass third arg as SubscirptionMain in super class 
