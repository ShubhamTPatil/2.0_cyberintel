...
public class DefinitionUpdateAction extends AbstractAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        init(request);
        DefinitionUpdateForm definitionUpdateForm = (DefinitionUpdateForm) form;
		...
		try {
           ...
           // loadFormData(getDefinitionsUpdateConfig(), definitionUpdateForm);
            ...
            String action = definitionUpdateForm.getAction();
			...
			if ("update_vdef".equals(action)) {
                ...
                if (!copyFailed) {
                    ...
                    config.setProperty("vdefchannel.lastcopied.timestamp", String.valueOf(currentTimestampVal));
               ...
               return (mapping.findForward("view"));
                ...
                definitionUpdateForm.setDefinationUpdateResponse(definationUpdateResponse);
				System.out.println("END - fetch definitions update metadata "+definationUpdateResponse.toString());
			}
		} catch (Exception ex) {
			ex.printStackTrace();
		}
