...
/**
 * Initializes a user object upon login or relogin after time out.  We execute this action when
 * initApp.do is called.
 *
 * @author Angela Saval
 * @author Theen-Theen Tan
 * @version $Date$, Revision$
 */
public class InitAppAction extends AbstractAction implements IWebAppConstants, IErrorConstants {
