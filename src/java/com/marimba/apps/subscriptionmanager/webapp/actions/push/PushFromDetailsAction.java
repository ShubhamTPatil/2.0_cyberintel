 ...
 */
public final class PushFromDetailsAction
    ...
    public ActionForward execute(ActionMapping       mapping,
        ...
        if (!(form instanceof IMapProperty)) {
            InternalException ie = new InternalException(GUIUTILS_INTERNAL_WRONGARG, "PushFromDetailsAction", form.toString());
        ...
        try {
            ...
            // set the activelimit property on the deploymentProps

            deploymentProps.setProperty("activeLimit", dmConfig.getProperty("dm.activelimit"));
            ...
            // if we don't.  Wait is to short to use DelayedAction.  Could improve if we
    ...
    */
    private String getSubscriptionServiceCommand(String id) {
        String publishurl = main.getConfig().getProperty("subscriptionmanager.publishurl");
