...
/**
 * Stop the deployment whose deployment bean should be present in the session
 *
 * @author Anantha Kasetty
 * @version $Revision$, $Date$
 */
public class PushStopAction
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        init(request);
        // throw an exception if deployment is null
        try {
            deployment.stop();
            GUIUtils.log(servlet, request, LOG_SUBSCRIPTION_PUSH_STOPPED, deploymentView.getDeploymentID());
