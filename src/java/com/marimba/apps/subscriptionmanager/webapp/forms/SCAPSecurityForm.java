...
public class SCAPSecurityForm extends AbstractForm {
    ...
    String remediate;
    String selectedScapAndProfilesNonWindows = null;
    ...
    public void reset(ActionMapping mapping,
        ...
        remediate = "false";
        selectedScapAndProfilesNonWindows = "";
        previewList = new HashMap<String, String>();
    }
    ...
    public String getSelectedScapAndProfilesNonWindows() {
        return selectedScapAndProfilesNonWindows;
    }

    public void setSelectedScapAndProfilesNonWindows(String selectedScapAndProfilesNonWindows) {
        this.selectedScapAndProfilesNonWindows = selectedScapAndProfilesNonWindows;
    }
