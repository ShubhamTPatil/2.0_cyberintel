...
public class TunerChPropsForm
    ...
    public void initialize() {
        props.put((Object) "tunerprop", (Object) "marimba.subscription.nodelete");
        props.put((Object) "tunerpropvalue", (Object) "true");
        props.put((Object) "tunerproptype", (Object) "boolean");

        if (DEBUG) {
            System.out.println("TunerChPropsForm: initialize called");
        }
    }
}
