...
public class USGCBSecurityForm extends AbstractForm {
    ...
    String remediate;
    String selectedScapAndProfiles = null;
    ...
    public String getSelectedScapAndProfiles() {
        return selectedScapAndProfiles;
    }

    public void setSelectedScapAndProfiles(String selectedScapAndProfiles) {
        this.selectedScapAndProfiles = selectedScapAndProfiles;
    }
