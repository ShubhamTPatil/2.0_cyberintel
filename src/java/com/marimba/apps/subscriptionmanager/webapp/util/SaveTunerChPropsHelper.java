...
import com.marimba.apps.subscriptionmanager.webapp.actions.SaveTempPropsAction;
 ...
 */
public final class SaveTunerChPropsHelper implements ISubscriptionConstants, IWebAppConstants, LogConstants
   {

     protected ArrayList conflicts = new ArrayList(10);

    public void setTunerChProps(ISubscription newsub,
                              //   ActionForm          form,
                                 HttpServletRequest  request  ) throws GUIException{
    ...
    class DiffProperties {
        ...
        private Vector findDeletes()
            ...
            String[] propertyTypes = { PROP_TUNER_KEYWORD, PROP_SERVICE_KEYWORD, PROP_CHANNEL_KEYWORD, PROP_DEVICES_KEYWORD,
                    PROP_ALL_CHANNELS_KEYWORD, PROP_DEVICES_KEYWORD, PROP_POWER_KEYWORD, PROP_AMT_KEYWORD, PROP_SECURITY_KEYWORD,
                    PRO_AMT_ALARMCLK_KEYWORD, PROP_OSM_KEYWORD, PROP_PBACKUP_KEYWORD, PROP_SCAP_SECURITY_KEYWORD, PROP_USGCB_SECURITY_KEYWORD, PROP_CUSTOM_SECURITY_KEYWORD};
